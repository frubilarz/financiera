...
\section{Antecendetes Generales de la Empresa}
	...
	\item Conos de PVC.
	\insertimage[]{serviplott/mixproducto3}{width=5cm}{Cono PVC.}
	\end{itemize}
	...
	\noindent{Para las señales existen distintos tipos de dimensiones y en algunas ocasiones figuras, tal como muestra la siguiente tabla:}
